...
**HR AI Analytics Assistant** یک Automation مبتنی بر n8n است که به کاربر اجازه می‌دهد سؤالات منابع انسانی خود را به زبان طبیعی و از طریق Telegram مطرح کند و متناسب با نوع سؤال، پاسخ مبتنی بر اسناد HR یا تحلیل Power BI دریافت کند.
